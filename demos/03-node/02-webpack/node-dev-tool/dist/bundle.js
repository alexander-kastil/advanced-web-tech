...
class FoodService {
    ...
    getFood() {
        return __awaiter(this, void 0, void 0, function* () {
            return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(this.url);
        });
    }
    addFood(item) {
        return __awaiter(this, void 0, void 0, function* () {
            return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(this.url, item);
        });
    }
}
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _food_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./food-service */ "./src/food-service.ts");
/* harmony import */ var _car__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./car */ "./src/car.ts");


console.log(`Manually init util`);
let service = new _food_service__WEBPACK_IMPORTED_MODULE_0__.FoodService('http://localhost:3000/food');
...
function driveCar() {
    let porsche = new _car__WEBPACK_IMPORTED_MODULE_1__.Car();
    porsche.drive();
}
driveCar();
