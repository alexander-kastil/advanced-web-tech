...
import styles from './SkillsWp.module.scss';
import { escape } from '@microsoft/sp-lodash-subset';
var SkillsWp = /** @class */ (function (_super) {
    __extends(SkillsWp, _super);
    function SkillsWp() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SkillsWp.prototype.render = function () {
        ...
        return (React.createElement("section", { className: "".concat(styles.skillsWp, " ").concat(hasTeamsContext ? styles.teams : '') },
...
export default SkillsWp;
//# sourceMappingURL=SkillsWp.js.map