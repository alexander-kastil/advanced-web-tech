...
var service = new food_service_1.FoodService('http://localhost:3000/food');
service.log();
service.getFoodFetch().then(function (data) { return console.log("current food: ".concat(data)); });
console.log("Init State");
var food = { name: 'Langos' };
service.addFood(food).then(function (resp) { return console.log('new food added:', resp); });
function driveCar() {
